...
<div class="wrapper">
  ...
  <div class="page">
    ...
    <div class="clear"></div>
      ...
      <tr><td id="sub" ><a href="pay_mess.php" style="color:white; ">MESS FEES</a></td></tr>
      <tr><td id="sub" style="background:#6C6"><a href="pay_rent.php" style="color:black">HOSTEL RENT</a></td></tr>  
 
      </table>  
    </div>
 <div style="width:70%;float:right;border:2px solid" >
<form method="post" action="rentpay_process.php"> 
...
?>
<tr><th colspan="3" bgcolor="#000000" align="center" style="color:#CCCCCC">HOSTEL RENT</th></tr>
<tr><th align="center">Hostel rent for this Year is</th></tr>

<?php
$rs=$ob->getrentpay($lid,$r[0]);
...
<input type="hidden" name="rid" value="<?php echo $r[0] ;?>">
</form>
</div>
<br>
...
<tr bgcolor="#999999" style="color:black"><th width="33%" align="center">YEAR</th><th width="33%" align="center">AMOUNT</th><th align="center">STATUS</th></tr>
<?php
$rs=$ob->renthistory($lid);
$rw=mysqli_num_rows($rs);
if($rw>0)
{
...
{
?>
<tr ><th style="text-indent:50px;color:#333"><?php echo date("Y",strtotime($r[1]));?></th><th align="center" style="color:#333"><?php echo $r[2] ;?></th>
...
{
echo "<span style='color:red'>DUE</span>&nbsp;&nbsp;&nbsp;&nbsp;<a style='background:#09F;color:white;border:1px solid blue;font:10px Tahoma;padding:2px;border-radius:4px' href='rentpay_process.php?rid=$r[0]'>PAY NOW</a>";	
}
?></th></tr>
<?php
}
