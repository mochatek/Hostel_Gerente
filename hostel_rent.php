...
<div class="wrapper">
  ...
  <div class="page">
    ...
    <div class="clear"></div>
      ...
      <tr><td id="sub" ><a href="mess_fees.php" style="color:white; ">MESS FEES</a></td></tr>
      <tr><td id="sub" style="background:#6C6" ><a href="hostel_rent.php" style="color:black">HOSTEL RENT</a></td></tr>  

      </table>     
    </div>
 <div style="width:70%;float:right;border:2px solid" >
<form method="post" action="rent_add_process.php"> 
...
{
?>
<tr><th colspan="3" bgcolor="#000000" align="center" style="color:#CCCCCC" colspan="2">ADD HOSTEL RENT FOR THIS YEAR</th></tr>
...
<tr><th align="center"><select  name="date"  id="date" style="width:200px" onchange="passdata()">
  ...
  while($r=mysqli_fetch_array($rs))
  {
	  ...
	  echo "<option value='$r[0]'>$y</option>";
  }
  ?>
 </select></th>
