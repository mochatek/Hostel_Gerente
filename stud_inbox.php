...
<div class="wrapper">
  ...
  <div class="page">
    ...
    <div class="clear"></div>
      ...
      <tr><td id="sub" ><a href="contact.php" style="color:white; ">CONTACT</a></td></tr>
      <tr><td id="sub" style="background:#6C6"><a href="stud_inbox.php" style="color:black">INBOX</a></td></tr>  
...
<br>
  ...
  {
  ?>
   <form  method="post" action="stud_replyprocess.php" >
  ...
  <p><u><?php echo $r[5];?></u><br><br><details><summary ><img src="images/user2.png" width="16" height="15" style="vertical-align: middle;"/><span style="vertical-align: middle; color:#666666; font:bold 14px Tahoma;">&nbsp;&nbsp;ADMIN</span></summary><hr><p style="margin-left:10%;margin-right:10%"><span style="text-align:justify; color:#000; font:bold 16px cambria;"><?php echo $r[4];?></span></p><hr><table width="80%" align="center" border="0" style="background-color:transparent;">
