 ...
 if($rw=mysqli_num_rows($res)>0)
{
 while($r=mysqli_fetch_array($res))
 {
	 ...
	 echo "<br><table width='100%' align='center' cellspacing='0'>";
	 echo "<tr><th align='right' rowspan='6' width='18%'><img src='images/$r[21]' width='100px' height='100px'style='max-width:100%;max-height:100%;border:3px;object-fit:contain'></th>";
