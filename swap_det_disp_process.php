...
echo " <form method='post' action='swap_acpt_rejt_process.php' style='border:2px solid;'>";
echo "<table align='center' cellspacing='20'><tr><th colspan='100%' style='font: bold 18px Tahoma;color:black' align='center'>ROOM MATES</th></tr><tr>";
...
echo "</tr><tr><th colspan='100%' align='center'><input type='submit' name='accept' value='ACCEPT' style='width:40%;background:green;color:white'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='submit' name='reject' value='REJECT' style='width:40%;background:orange;color:white'></th></tr></table>";
echo "</form>";
?>
